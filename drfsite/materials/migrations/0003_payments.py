# Generated by Django 5.0.1 on 2024-01-20 02:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sum_paid', models.IntegerField(verbose_name='Сумма оплаты')),
                ('payment_method', models.CharField(choices=[('cash', 'наличные'), ('card', 'перевод')], default='cash', max_length=10, verbose_name='способ оплаты')),
